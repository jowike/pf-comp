...
def main():
    ...
    for ds_fname in ds_listdir:
        ...
        print(
            f'Y field: {y_code}, reference date: {reference_date.strftime("%Y-%m-%d")}'
        )
        ...
        for model in estimators:
            ...
            for ref_date in fcst_ref_dates:
                ...
                try:
                    ...
                    coef_series = pd.Series(
                        np.round(
                            model.base_estimator_.fit(X_train, y_train).coef_[0], 5
                        ),
            ...
            eval_out = evaluate(
                ...
                metrics=["rmse", "rmspe", "mape", "smape", "mrae", "rrse"],
            )
